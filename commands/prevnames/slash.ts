...
import { prevnamesRequest } from '../../src/functions/prevnames';
...
export const slashCommand: SlashCommand = {
    data: new SlashCommandBuilder()
        .setName('prevnames')
        .setDescription('Retrieve the previous usernames or display names of a user.')
        .setDescriptionLocalization(
            'fr',
            "Permet d'obtenir les anciens noms d'utilisateur ou surnoms d'un utilisateur.",
        )
        .addStringOption((option) =>
            option.setDescription('The type of previous name to retrieve (username or display name).')
                .setName('type')
                .setDescriptionLocalization(
                    'fr',
                    'Le type de nom précédent à récupérer (nom d’utilisateur ou surnom).',
                )
                .addChoices(
                    {
                        name: '› Username',
        ...
        .addUserOption((option) =>
            option
                .setDescription('The user whose previous names you want to retrieve.')
                .setName('user')
                .setDescriptionLocalization(
                    'fr',
